...
public class KeyPreviewsManager implements KeyPreviewsController {
  ...
  public KeyPreviewsManager(
    ...
    mUiHandler =
        new UIHandler(this, context.getResources().getInteger(R.integer.preview_dismiss_delay));
  ...
  private boolean isKeyCodeShouldNotBeShown(int code) {
    return code == KeyCodes.KEYBOARD_MODE_CHANGE;// code <= 0 || code == KeyCodes.ENTER || code == KeyCodes.SPACE;
  }
